            ...
            <div className="col-lg-12">
              <div className="inner text-center mt--140">
                ...
                <p className="description">
                  Yapay zeka destekli sohbet asistanımız ile <br />{" "}
                  YKS sınavında Destek AL'ın
                </p>
                <div className="form-group">
                  <textarea
                    ...
                    cols="30"
                    rows="2"
                    placeholder="Örneğin: TYT Netlerimi nasıl arttırabilirim?"
                  ></textarea>
                  <Link className="btn-default " href="/text-generator">
                    Destek AL AI ile Başla
                  </Link>
                </div>
            ...
            <div className="col-lg-12">
              ...
              >
                <p className="b1 mb--0 small-title">
                  Destek AL AI'ın diğer projeleri
                </p>
              </div>
            </div>
          </div>
              ...
              >
                <h4 className="subtitle">
                  <span className="theme-gradient">
                    YAPAY ZEKA POTANSİYELİNİ KEŞFET
                  </span>
                </h4>
                <h2 className="title mb--0">
                  Sınava Hazırlık Sürecinde <br /> Yapay Zeka.
                </h2>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                <h4 className="subtitle">
                  <span className="theme-gradient">Kişilere Yardım</span>
                </h4>
                <h2 className="title mb--60">
                  Daha Akıllı Sohbet, <br /> Daha Kolay İletişim
                </h2>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                <h4 className="subtitle ">
                  <span className="theme-gradient">Yapay Zeka İşbirliği</span>
                </h4>
                <h2 className="title mb--20">
                  Kesintisiz işbirliği için
                  <br /> AI sohbet uygulaması
                </h2>
                <Link
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                <h4 className="subtitle">
                  <span className="theme-gradient">Kullanıcı Deneyimleri</span>
                </h4>
                <h2 className="title mb--60">Topluluk Görüşleri</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                ...
                <p className="subtitle mb--0">20,000+ değerlendirme üzerinden</p>
              </div>
            </div>
          </div>
          <BrandTwo />
